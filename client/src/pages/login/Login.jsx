            ...
            <div className="bg-white text-gray-500 max-w-96 mx-4 md:p-6 p-4 text-left text-sm rounded-xl shadow-[0px_0px_10px_0px] shadow-black/10">
                ...
                <form>
                    ...
                    <div className="text-right py-4">
                        <a className="text-blue-400 underline" href="#">Forgot Password</a>
                    </div>
                    <button type="submit" className="w-full mb-3 bg-blue-400 py-2.5 rounded-full text-white cursor-pointer">Log in</button>
                </form>
